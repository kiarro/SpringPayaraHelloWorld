...
function BackButton() {
  ...
  return (
    <nav className='ButtonContainerLeft'>
      <Link to=""  hidden={location.pathname=="/"}><HeaderButton name="Назад" /></Link>
      <Link to="/backed"  hidden={location.pathname!="/"}><HeaderButton name="Другая таблица" /></Link>
    </nav>
  );
}
      ...
      <div className="Body">
        <Router>
          ...
          <Routes>
            ...
            <Route path='/backed' element={<DragonTable_back />} />
